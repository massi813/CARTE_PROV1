...
map.getView().fit([-741560.965423, 1039950.395889, 622537.231225, 1719929.311288], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">population des provinces de 2006 du BFA</h2>';
        return titleElement;
    })(),
